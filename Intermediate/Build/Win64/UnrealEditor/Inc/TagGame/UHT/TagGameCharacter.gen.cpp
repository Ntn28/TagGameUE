...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ATagGameCharacter_Statics::NewProp_CameraBoom = { "CameraBoom", nullptr, (EPropertyFlags)0x00400000000a001d, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ATagGameCharacter, CameraBoom), Z_Construct_UClass_USpringArmComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CameraBoom_MetaData), NewProp_CameraBoom_MetaData) };
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ATagGameCharacter_Statics::NewProp_DefaultMappingContext = { "DefaultMappingContext", nullptr, (EPropertyFlags)0x0040000000000015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ATagGameCharacter, DefaultMappingContext), Z_Construct_UClass_UInputMappingContext_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DefaultMappingContext_MetaData), NewProp_DefaultMappingContext_MetaData) };
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ATagGameCharacter_Statics::NewProp_LookAction = { "LookAction", nullptr, (EPropertyFlags)0x0040000000000015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ATagGameCharacter, LookAction), Z_Construct_UClass_UInputAction_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_LookAction_MetaData), NewProp_LookAction_MetaData) };
...
// End Class ATagGameCharacter

// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_ntnca_Documents_Unreal_Projects_TagGame_Source_TagGame_TagGameCharacter_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ATagGameCharacter, ATagGameCharacter::StaticClass, TEXT("ATagGameCharacter"), &Z_Registration_Info_UClass_ATagGameCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATagGameCharacter), 2313816494U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ntnca_Documents_Unreal_Projects_TagGame_Source_TagGame_TagGameCharacter_h_170384753(TEXT("/Script/TagGame"),
	Z_CompiledInDeferFile_FID_Users_ntnca_Documents_Unreal_Projects_TagGame_Source_TagGame_TagGameCharacter_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_ntnca_Documents_Unreal_Projects_TagGame_Source_TagGame_TagGameCharacter_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
